"""
Welcome to the project of Railway  Reservation management system
...
a=0  #global variable
user_details = {1234:['Saraswathi','0000','Karnataka',9800000000]}
...
user_bookings ={234567890:[1234,'Yessu','odisha',1,'wed']}
                        ...
                        def check_tain_details(train_details,a):
                            for i in train_details:
                                if source_station in train_details[i] and destination_station  in train_details[i]:
                                    ...
                                    a=a+1
                                    if a==3:
                                        print(" Trains are not available!")
                                        return 3
                    ...
                    if pass_word==user_details[id][1]:
                        ...
                        if pnr_numer in user_bookings:
                            ...
                            if cancel=='y': 
                                ...
                                print(" successfully! tickets are  Canceled")
                                print("Money refund  within  2 days to your account:)")
                            else:
                                print("Not canceled !")
                        else:
        ...
        def check_user_id(user_details):
            ...
            if id in user_details:
                def check_password(user_details):
                    ...
                    if pass_word==user_details[id][1]:
                        print("Welcome ",user_details[id][0],"!")
                        print("city: ",user_details[id][2])
                        print("mob no: ",user_details[id][3])   
                    else:
                        print("Invalid password")
                        check_password(user_details)
                check_password(user_details)
